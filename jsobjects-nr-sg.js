...
person.donde = function() {
    return `${this.firstName + " " + this.lastName} is from planet ${this.homePlanet}`
}
console.log(person.donde())
...
let totalWithTax = (product) => {
    let a = product.price * .07;
    let b = product.price + a;
    let c = (b).toFixed(2)
    return c
}
...
console.log(inIt(lunch))
// Update the lunch object with method that returns "The ingredients for a PB and Banana sandwich are bread, peanut butter, and banana."
 lunch.ingredients.splice(2, 0, "and")
 console.log(inIt(lunch))
// Consider this variable:
...
theCats = animals.filter (value => value.type === "cat")
console.log(theCats)
// Create a function that takes in an array of animal objects and returns a new array with only the names of the animals.
// let names = (object) => {
//     return object.map(x => typeof Object === "string")
// }
