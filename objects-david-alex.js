...
const totalWithTax = (productInput) => { 
    return productInput.price * .07
...
const makeLunch = (lunch1) => {
    return `The ingredients for a ${lunch1.name} ${lunch1.type} are ${lunch1.ingredients[0]}, ${lunch1.ingredients[1]}, ${lunch1.ingredients[2]}.`
}

console.log(makeLunch(lunch))

console.log(lunch.makeLunch1())
