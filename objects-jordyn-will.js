...
const justCats = animals.filter(function(animal) {
    return animal.type === 'cat';
   })
console.log(justCats)
//Output:   { name: 'Fluffy', type: 'cat', age: 14 },
 // { name: 'Hank', type: 'cat', age: 11 }

const animalNames = animals.filter(function(animals) {
     return animalNames;
   })
